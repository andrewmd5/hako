...
export interface HakoExports {
   ...
   */
  HAKO_RuntimeComputeMemoryUsage(
    rt: JSRuntimePointer,
   ...
   */
  HAKO_CompileToByteCode(
    ctx: JSContextPointer,
    js_code: CString,
    js_code_length: number,
    filename: CString,
    detect_module: LEPUS_BOOL,
    flags: number,
    out_bytecode_length: number
  ): number;
  /**
   ...
   */
  HAKO_NewObjectProtoClass(
    ctx: JSContextPointer,
    proto: JSValueConstPointer,
    class_id: number
  ): JSValuePointer;
  /**
   ...
   */
  HAKO_RuntimeEnableInterruptHandler(
    rt: JSRuntimePointer,
    opaque: number
  ): void;
   ...
   */
  HAKO_GetModulePrivateValue(
    ctx: JSContextPointer,
    module: LEPUSModuleDef
  ): JSValuePointer;
  /**
   ...
   */
  HAKO_GetModuleNamespace(
    ctx: JSContextPointer,
    module_func_obj: JSValueConstPointer
  ): JSValuePointer;
  /**
   ...
   */
  HAKO_RuntimeEnableModuleLoader(
    rt: JSRuntimePointer,
   ...
   */
  HAKO_NewPromiseCapability(
    ctx: JSContextPointer,
    resolve_funcs_out: number
  ): JSValuePointer;
  /**
   ...
   */
  HAKO_ArgvGetJSValueConstPointer(
    argv: number,
    index: number
  ): JSValueConstPointer;
  /**
  ...
  HAKO_Call(
    ctx: JSContextPointer,
    func_obj: JSValueConstPointer,
    this_obj: JSValueConstPointer,
    argc: number,
    argv_ptrs: number
  ): JSValuePointer;
  /**
  ...
  HAKO_DefineProp(
    ctx: JSContextPointer,
    this_val: JSValueConstPointer,
    prop_name: JSValueConstPointer,
    prop_value: JSValueConstPointer,
    get: JSValueConstPointer,
    set: JSValueConstPointer,
    configurable: LEPUS_BOOL,
    enumerable: LEPUS_BOOL,
    has_value: LEPUS_BOOL
  ): LEPUS_BOOL;
  /**
   ...
   */
  HAKO_GetSymbolDescriptionOrKey(
    ctx: JSContextPointer,
    value: JSValueConstPointer
  ): CString;
  /**
  ...
  HAKO_IsEqual(
    ctx: JSContextPointer,
    a: JSValueConstPointer,
    b: JSValueConstPointer,
    op: number
  ): LEPUS_BOOL;
  /**
